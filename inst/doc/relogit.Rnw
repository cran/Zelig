...
\begin{verse}
Kosuke Imai, Gary King, and Olivia Lau. 2007. ``relogit: Rare Events Logistic Regression for Dichotomous Dependent Variables,'' in Kosuke Imai, Gary King, and Olivia Lau, ``Zelig: Everyone's Statistical Software,'' \url{http://gking.harvard.edu/zelig}.
\end{verse}
\input{citeZelig}
