\SweaveOpts{results=hide, prefix.string=vigpics/probit_gee}
\include{zinput}
%\VignetteIndexEntry{Generalized Estimating Equation for Probit Regression}
%\VignetteDepends{Zelig, gee}
%\VignetteKeyWords{model,generalized estimating equation, probit regression}
...
\begin{verse}
Patrick Lam. 2007. ``probit.gee: Generalized Estimating Equation for Probit Regression,'' in Kosuke Imai, Gary King, and Olivia Lau, ``Zelig: Everyone's Statistical Software,'' \url{http://gking.harvard.edu/zelig}.
