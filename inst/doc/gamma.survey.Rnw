\SweaveOpts{results=hide, prefix.string=vigpics/gammasurvey}
\include{zinput}
...
To cite the \emph{gamma.survey} Zelig model: \begin{verse} Nicholas 
Carnes. 2008. ``gamma.survey: Survey-Weighted Gamma Regression for 
Continuous, Positive Dependent Variables,'' in Kosuke Imai, Gary 
