...
To cite the \emph{netls} Zelig model:
\begin{verse}
Skyler J. Cranmer. 2007. ``netls: Network Least Squares Regression for Continuous Proximity Matrix Dependent Variables,'' in Kosuke Imai, Gary King, and Olivia Lau, ``Zelig: Everyone's Statistical Software,'' \url{http://gking.harvard.edu/zelig}.
