\SweaveOpts{results=hide, prefix.string=vigpics/probitmixed}
\include{zinput}
...
\begin{verse}
Delia Bailey, Ferdinand Alimadhi. 2007. ``probit.mixed: Mixed effects probit regression'' in Kosuke Imai, Gary King, and Olivia Lau, ``Zelig: Everyone's Statistical Software,'' \url{http://gking.harvard.edu/zelig}.
