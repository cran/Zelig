\SweaveOpts{results=hide, prefix.string=vigpics/logitsurvey}
\include{zinput}
...
\begin{verse}
Nicholas Carnes. 2008. ``logit.survey: Survey-weighted Logistic
Regression  for Dichotomous Dependent Variables,'' in Kosuke Imai,
...
help(svrepdesign)}.  The logit model is part of the stats package
