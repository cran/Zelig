...
To cite the \emph{irt1d} Zelig model use:
\begin{verse}
Ben Goodrich and Ying Lu. 2007. ``irt1d: One Dimensional Item Response Mode,'' in Kosuke Imai,Gary King, and Olivia Lau, ``Zelig: Everyone's Statistical Software,'' \url{http://gking.harvard.edu/zelig}.
\end{verse}
\input{citeZelig}
\subsection*{See also}
The unidimensional item-response function is part of the MCMCpack library by Andrew D. Martin and Kevin M. Quinn \citep{MarQui05}.
