\SweaveOpts{results=hide, prefix.string=vigpics/gammamixed}
\include{zinput}
...
\begin{verse}
Delia Bailey, Ferdinand Alimadhi. 2007. ``gamma.mixed: Mixed effects gamma regression'' in Kosuke Imai, Gary King, and Olivia Lau, ``Zelig: Everyone's Statistical Software,'' \url{http://gking.harvard.edu/zelig}.
