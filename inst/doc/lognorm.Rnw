...
\begin{verse}
Kosuke Imai, Gary King, and Olivia Lau. 2007. ``lognorm: Log-Normal Regression for Duration Dependent Variable,'' in Kosuke Imai, Gary King, and Olivia Lau, ``Zelig: Everyone's Statistical Software,'' \url{http://gking.harvard.edu/zelig}.
