...
\begin{verse}
Kosuke Imai, Gary King, and Olivia Lau. 2007. ``ologit: Ordinal Logistic Regression  for Ordered Categorical Dependent Variables,'' in Kosuke Imai, Gary King, and Olivia Lau, ``Zelig: Everyone's Statistical Software,'' \url{http://gking.harvard.edu/zelig}.
