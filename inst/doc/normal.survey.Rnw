...
\begin{verse}
Nicholas Carnes. 2008. ``normal.survey: Survey-weighted Normal
Regression  for Continuous Dependent Variables,'' in Kosuke Imai,
...
help(svrepdesign)}.  The normal model is part of the stats package
