\SweaveOpts{results=hide, prefix.string=vigpics/poisson_gee}
\include{zinput}
%\VignetteIndexEntry{Generalized Estimating Equation for Poisson Regression}
%\VignetteDepends{Zelig, gee}
%\VignetteKeyWords{model,generalized estimating equation, poisson regression}
...
\begin{verse}
Patrick Lam. 2007. ``poisson.gee: Generalized Estimating Equation for Poisson Regression,'' in Kosuke Imai, Gary King, and Olivia Lau, ``Zelig: Everyone's Statistical Software,'' \url{http://gking.harvard.edu/zelig}.
