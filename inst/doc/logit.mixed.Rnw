...
%\VignetteKeyWords{mixed,logit regression}                                                                          
...
\begin{verse}
Delia Bailey, Ferdinand Alimadhi. 2007. ``logit.mixed: Mixed effects logistic regression'' in Kosuke Imai, Gary King, and Olivia Lau, ``Zelig: Everyone's Statistical Software,'' \url{http://gking.harvard.edu/zelig}.
