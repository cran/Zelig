\SweaveOpts{results=hide, prefix.string=vigpics/gamma_gee}
\include{zinput}
%\VignetteIndexEntry{Generalized Estimating Equation for Gamma Regression}
%\VignetteDepends{Zelig, gee}
%\VignetteKeyWords{model,generalized estimating equation, gamma regression}
...
\begin{verse}
Patrick Lam. 2007. ``gamma.gee: Generalized Estimating Equation for Gamma Regression,'' in Kosuke Imai, Gary King, and Olivia Lau, ``Zelig: Everyone's Statistical Software,'' \url{http://gking.harvard.edu/zelig}.
